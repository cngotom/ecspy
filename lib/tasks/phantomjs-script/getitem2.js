...
//	page.settings.userAgent = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36';
	...
	page.onResourceRequested = function(requestData, request) {
		...
		if(requestData['url'].indexOf('gm.mmstat.com') != -1)
			request.abort();
		else{

		    if ( requestData['url'].indexOf('.jpg') != -1 || requestData['url'].indexOf('.gif') != -1||requestData['url'].indexOf('.png') != -1 ) {
		    	requestData['url'] = './README.rdoc';
		        //console.log('The url of the request is matching. Aborting: ' + requestData['url']);
		        //request.abort();
			}
			else
				;//console.log( JSON.stringify(requestData['url']));
		}
	};
			 	 ...
			 	 page.evaluate(function() {
			 	 		...
			 	 		WaiUntil(
				 	 		...
				 	 		function(){
			 	 				...
			 	 				window.scroll(0, getElementAbsPos($('#J_showBuyerList')[0]));
